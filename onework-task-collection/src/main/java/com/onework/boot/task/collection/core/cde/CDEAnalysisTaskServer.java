...
import com.onework.boot.task.collection.core.cde.config.CDEAnalysisConfiguration;
import com.onework.boot.task.collection.core.cde.dtos.*;
import com.onework.boot.task.collection.core.cde.store.CDEInstitutionStore;
import com.onework.boot.task.collection.core.cde.store.CDEResearcherStore;
import com.onework.boot.task.collection.core.cde.store.CDESponsorStore;
import com.onework.boot.task.collection.dao.entity.CDEInstitution;
import com.onework.boot.task.collection.dao.entity.CDEProject;
import com.onework.boot.task.collection.dao.entity.CDEResearcher;

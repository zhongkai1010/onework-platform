...
import com.onework.boot.framework.monitor.core.aop.BizTraceAspect;
import com.onework.boot.framework.monitor.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "onework.tracer", value = "enable", matchIfMissing = true)
public class OneworkTracerAutoConfiguration {

package com.onework.boot.module.system.controller.admin.permission.vo.role;
...
public class RolePageReqVO extends PageParam {
    ...
    @Schema(description = "角色名称，模糊匹配", example = "Onework")
    private String name;

    @Schema(description = "角色标识，模糊匹配", example = "onework")
    private String code;

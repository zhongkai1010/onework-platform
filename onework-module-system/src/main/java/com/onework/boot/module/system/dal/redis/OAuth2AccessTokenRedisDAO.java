...
import static com.onework.boot.module.system.dal.redis.RedisKeyConstants.OAUTH2_ACCESS_TOKEN;
...
public class OAuth2AccessTokenRedisDAO {
    ...
    public void set(OAuth2AccessTokenDO accessTokenDO) {
        ...
        if (time > 0) {
            stringRedisTemplate.opsForValue().set(redisKey, Objects.requireNonNull(JsonUtils.toJsonString(accessTokenDO)), time, TimeUnit.SECONDS);
        }
    }

package com.onework.boot.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientRespVO {
    ...
    @Schema(description = "客户端编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "onework")
    ...
    @Schema(description = "应用图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.onework.cn/xx.png")
    private String logo;
    ...
    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.onework.cn")
    ...
    @Schema(description = "附加信息", example = "{onework: true}")

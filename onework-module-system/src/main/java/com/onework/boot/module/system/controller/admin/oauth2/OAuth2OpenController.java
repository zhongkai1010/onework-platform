...
import com.onework.boot.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.onework.boot.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.onework.boot.module.system.service.oauth2.OAuth2ApproveService;
import com.onework.boot.module.system.service.oauth2.OAuth2ClientService;
import com.onework.boot.module.system.service.oauth2.OAuth2GrantService;
...
import static com.onework.boot.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.onework.boot.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static com.onework.boot.framework.common.pojo.CommonResult.success;
import static com.onework.boot.framework.common.util.collection.CollectionUtils.convertList;
import static com.onework.boot.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.onework.cn"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.onework.cn"),

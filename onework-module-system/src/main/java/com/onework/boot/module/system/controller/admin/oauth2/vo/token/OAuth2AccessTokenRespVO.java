package com.onework.boot.module.system.controller.admin.oauth2.vo.token;
...
public class OAuth2AccessTokenRespVO {
    ...
    @Schema(description = "访问令牌", requiredMode = Schema.RequiredMode.REQUIRED, example = "onework")

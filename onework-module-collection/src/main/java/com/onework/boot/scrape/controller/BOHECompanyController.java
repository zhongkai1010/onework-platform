...
import com.onework.boot.scrape.controller.vo.BOHECompanyPageReqVO;
import com.onework.boot.scrape.controller.vo.BOHECompanyReqVO;
 ...
 */
@RestController
@RequestMapping("/scrape/bohe-company")

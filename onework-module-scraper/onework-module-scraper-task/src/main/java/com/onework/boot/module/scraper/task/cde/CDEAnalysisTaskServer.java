...
import com.onework.boot.module.scraper.task.cde.config.CDEAnalysisConfiguration;
import com.onework.boot.module.scraper.task.cde.dtos.*;

import com.onework.boot.module.scraper.task.cde.store.CDEInstitutionStore;
import com.onework.boot.module.scraper.task.cde.store.CDEResearcherStore;
import com.onework.boot.module.scraper.task.cde.store.CDESponsorStore;
